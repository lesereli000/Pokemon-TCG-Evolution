...
- All cards have a Name. [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/e6f24b89c0808445175e24bb2151ca89d42f92df)
    - BVA: Strings
...
- All cards have a Type from among the following:
    ...
    - Pokémon [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/e6f24b89c0808445175e24bb2151ca89d42f92df)
         - All Pokémon cards are one or more of the energy types. [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/e6f24b89c0808445175e24bb2151ca89d42f92df)

         - All Pokémon cards are either [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/e6f24b89c0808445175e24bb2151ca89d42f92df)
              - Basic
              - Stage 1
              - Stage 2
         ...
         - All Pokémon cards have the following attributes:
              - HP 
                   - If a Pokémon’s HP is ever less than or equal to the total damage on that Pokémon it is knocked out. [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/db3eee16aa14bf28520c9029529f9a868d00c237)
              ...
              - Damage Counters (DC) [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/e6f24b89c0808445175e24bb2151ca89d42f92df)
              ...
              - Attacks 
                   - Each attack the Pokémon can use will have:
                        - Name [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/312d9e489022f7be1ecdf2b552b5ad9efc8e9e3e)
                             - BVA: Strings
                        ...
                        - Energy Requirement [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/312d9e489022f7be1ecdf2b552b5ad9efc8e9e3e)
                        ...
                        - Damage [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/312d9e489022f7be1ecdf2b552b5ad9efc8e9e3e)
              ...
              - Weaknesses [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/8817eaf34415c3784b4f783a7c77c32ffd2c6dc9)
              ...
              - Resistances [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/8817eaf34415c3784b4f783a7c77c32ffd2c6dc9)
              ...
              - Retreat Cost (RC) [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/6834cfa4c8a3d1bf942bd78bd1414f87d600f74f)
    ...
    - Trainer [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/eb0b1c068539e701c6f0667ac44d92ba0d58408f)
    ...
    - Energy [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/e6f24b89c0808445175e24bb2151ca89d42f92df)
...
- Hand: [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/9bd5b4f5f54890a7542f61d4e21c792a474acade)
...
- Deck: [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/97db8ea0bb955a99a8bec145b075411f30ae629e)
...
- Prize Cards: [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/d643f0881414cceaab2d5ebc05ebbfc817fff9c2)
...
- Active Pokémon: [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/87db9f503cd9b8a4dea35b243bd03cfa3a624ca6)
...
- Bench: [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/e6f24b89c0808445175e24bb2151ca89d42f92df)
...
- Players select language to play in [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/c9e7bd15a3a463bed1d852925a5018fd2c0e458c)
- 2 players are created [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/f5d2e9e7a7969be820539ff19b6fdfd389b4dfc4)
- Their decks, and the cards in them, are created and assigned [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/f5d2e9e7a7969be820539ff19b6fdfd389b4dfc4)
- Coin is flipped to decide who gets to play first [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/edbbfaa58f5579d575df19cbf4e88fd25bc301fb)
     - BVA: Boolean
         - 0: player 1 goes first
         - 1: player 2 goes first
         - any other true value: throw an exception showing that the coin flip has failed
- Each player draws 7 cards from their deck to their hand [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/f5d2e9e7a7969be820539ff19b6fdfd389b4dfc4)
- Basic Pokémon can be assigned as active Pokémon or added to their bench (face down, unable to be viewed by their opponent) [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/2f638dca1f3577cd1c5ae897c789a50094b8ed03)
...
- Top 6 cards of the deck should be placed down as Prize cards [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/f5d2e9e7a7969be820539ff19b6fdfd389b4dfc4)
- Whoever won the coinflip is then able to begin playing first, the other player should not be able to make any changes while it is their opponents turn [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/f5d2e9e7a7969be820539ff19b6fdfd389b4dfc4)



Players Turn Functionality is Complete When: 

- Able to switch turns between player (so that only the person who should play is able to play) [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/f61d9a164868885410fbc76e3adbe6de4a47fd08)
- Able to draw a card and add it to their hand [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/85c52d53f45e779a12e45f34e0c45f79896236a7)
- Able to do all of the following, in any order:
    - Put basic Pokémon cards from your hand onto your bench (as many times as you want, max of 5 on bench) [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/43cdb3e8dd32b8a3c7aa7ecf90d2502639d27296)
    - Evolve your Pokémon (as many times as you want following the evolution rules) [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/9d1926c0b9932f47677f16ccd67b6ca3bcc78a23)
    ...
    - Play trainer cards (as many as you want) [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/eb0b1c068539e701c6f0667ac44d92ba0d58408f)
        - When a trainer card is played, all of the necessary rules and actions should be performed
    - Retreat your active Pokémon [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/9d45f2af5d5af40f70298f8ecb5d40ed5cfea1ee)
        - If you retreat, you can still attack that turn with your new Active Pokémon.
    - Able to attack [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/c69fb480e8d64556cc6a58a8fe55099c521e9adb)
    ...
    - End turn and continue to the next steps [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/f61d9a164868885410fbc76e3adbe6de4a47fd08)

    
Ending the Game:

- You win the game if any of the following occurs:
    - You take your last Prize card. [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/194768a5f3239222b0f82e0a394b7b58ffc820fc)
    - Your opponent has no more Pokémon in play. [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/9459809dc408f82d8f226b443ca5aaec387b49f1)
    - Your opponent must draw a card, and their deck is empty. [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/85c52d53f45e779a12e45f34e0c45f79896236a7)


Additional Rules: 

- Whenever a Pokémon is knocked out, its controller chooses a Pokémon from their bench to replace the knocked-out Pokémon. The other player puts one of their Prize cards into their hand without revealing it. [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/d643f0881414cceaab2d5ebc05ebbfc817fff9c2)
- Colorless Energy Requirements and costs can be met with any Type of Energy. [commit](https://github.com/rhit-csse376/S1G2NewGame/commit/200d0672a8d8df771f4857cb5e8ea9bdf25b6ef2)
